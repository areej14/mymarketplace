        ...
        <div class="section-box">
          <div class="breadcrumbs-div">
            <div class="container">
              <ul class="breadcrumb">
                <li>
                  <a class="font-xs color-gray-1000" href="index.html">
                    Home
                  </a>
                </li>
                <li>
                  <a class="font-xs color-gray-500" href="shop-grid.html">
                    Electronics
                  </a>
                </li>
                <li>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <a class="byAUthor" href="shop-vendor-single.html">
                  {" "}
                  Ecom Tech
                </a>
                ...
                <a class="mr-30" href="shop-wishlist.html">
                ...
                <div class=" mt-10 font-md color-gray-900">
                 
                 
                 
                  
                  
                  <span class="font-md color-gray-900">  Tags: Blue, Smartphone</span>
                ...
                <div class="row mt-40">
                  <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card-grid-style-2 card-grid-none-border hover-up">
                      ...
                      <div class="info-right">
                        <span class="font-xs color-gray-500">Apple</span>
                        <br />
                        <a
                    ...
                    <ul class="list-checkbox">
                      <li class="mb-5">
                        <a href="#">
                          ...
                          <img src={star} alt="Ecom" />
                          <img src={star} alt="Ecom" />
                          <span class="ml-10 font-xs color-gray-500 d-inline-block align-top">
                            (5 stars)
                          </span>
                        </a>
                      </li>
