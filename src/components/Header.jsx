  ...
  return (
    ...
    <div className="container">
      <div className="main-header">
        <div className="header-left">
          <div className="header-logo"><a href="#"><img alt="Ecom" src={favicon}/></a></div>
          <div className="header-search">

            <div className="box-header-search">
              <form className="form-search" method="post" action="#">
                <div className="box-category">
                  <select className="select-active select2-hidden-accessible" data-select2-id="1" tabindex="-1"
                    aria-hidden="true">
                    <option>All categories</option>
                    <option value="Computers Accessories">Clothing & Apparel</option>
                    ...
                    <option value="Mouse &amp; Keyboard">Games & Toys</option>
                    <option value="Headphone">Stationery</option>
                    <option value="Bluetooth devices">Furniture & Equipment</option>
                    ...
                    <option value="Cloud Software">Exercise/Fitness supplies</option>
                    <option value="Cloud Software">Jewellery</option>
                    <option value="Cloud Software">Infant/Baby Products</option>
          ...
          <div className="header-shop">
            <div className="d-inline-block box-dropdown-cart"><span
                className="font-lg icon-list icon-account"><span>Account</span></span>
            ...
            </div><a className="font-lg icon-list icon-wishlist" href="shop-wishlist.html"><span>Wishlist</span><span
                className="number-item font-xs">5</span></a>
            <div className="d-inline-block box-dropdown-cart"><span
                className="font-lg icon-list icon-cart"><span>Cart</span><span className="number-item font-xs">2</span></span>
              <div className="dropdown-cart">
                <div className="item-cart mb-20">
                  <div className="cart-image"><img src="assets/imgs/page/homepage1/imgsp5.png" alt="Ecom"/></div>
                  <div className="cart-info"><a className="font-sm-bold color-brand-3" href="shop-single-product.html">2022
                      Apple iMac with Retina 5K Display 8GB RAM, 256GB SSD</a>
                    <p><span className="color-brand-2 font-sm-bold">1 x $2856.4</span></p>
                  </div>
                </div>
                <div className="item-cart mb-20">
                  <div className="cart-image"><img src="assets/imgs/page/homepage1/imgsp4.png" alt="Ecom"/></div>
                  <div className="cart-info"><a className="font-sm-bold color-brand-3" href="shop-single-product-2.html">2022
                      Apple iMac with Retina 5K Display 8GB RAM, 256GB SSD</a>
                    <p><span className="color-brand-2 font-sm-bold">1 x $2856.4</span></p>
                  </div>
                </div>
                ...
                <div className="cart-total">
                  ...
                  <div className="row mt-15">
                    <div className="col-6 text-start"><a className="btn btn-cart w-auto" href="shop-cart.html">View cart</a>
                    </div>
    ...
    <div id="wdw_NavBar" className="header-bottom">
      <div className="container">
          ...
          <button className="btn dropdown-toggle btn-category" id="dropdownCategory" type="button" data-bs-toggle="dropdown"aria-expanded="true" data-bs-display="static"><span className="dropdown-right font-sm-bold color-white">Shop ByCategories</span></button>                
          <div className="dropdown-menu dropdown-menu-light wdw_FixedManu" aria-labelledby="dropdownCategory" data-bs-popper="static">
                <div className="container">
                    <div className="sidebar-left">
                        <ul className="menu-texts menu-close">
        
                      <li className="has-children"><a href="javascript:;"><span className="img-link"><img
                              src={monitor} alt="Ecom"/></span><span className="text-link">Clothing &amp;
                            Apparel</span></a>
                        <ul className="sub-menu">
                          <li><a href="#">Men</a></li>
                      ...
                      <li className="has-children"><a href="javascript:;"><span className="img-link"><img
                              src={monitor} alt="Ecom"/></span><span
                            className="text-link">Footwear/Shoes</span></a>
                        <ul className="sub-menu">
                          <li><a href="#">Men</a></li>
                          <li><a href="#">Women </a></li>
                          <li><a href="#">Kids</a></li>
                      ...
                      <li className="has-children"><a href="javascript:;"><span className="img-link"><img
                              src={monitor} alt="Ecom"/></span><span
                            className="text-link">Cosmetics</span></a>
                        <ul className="sub-menu">
                      ...
                      <li className="has-children"><a href="javascript:;"><span className="img-link"><img
                              src={monitor} alt="Ecom"/></span><span
                            className="text-link">Electronics</span></a>
                        <ul className="sub-menu">
                      ...
                      <li><a href="#"><span className="img-link"><img src={monitor} alt="Ecom"/></span><span
                            className="text-link">Digital Gadgets</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor} alt="Ecom"/></span><span
                            className="text-link">Games & Toys</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor} alt="Ecom"/></span><span
                            className="text-link">Stationery</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor} alt="Ecom"/></span><span
                            className="text-link">Wired Headphone</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor} alt="Ecom"/></span><span
                            className="text-link">Furniture & Equipment</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor}
                              alt="Ecom"/></span><span className="text-link">Sports Products</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor}
                              alt="Ecom"/></span><span className="text-link">Health & Medical</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor} alt="Ecom"/></span><span
                            className="text-link">Home Decor</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor}
                              alt="Ecom"/></span><span className="text-link">Bakery</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor} alt="Ecom"/></span><span
                            className="text-link">Groceries</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor} alt="Ecom"/></span><span
                            className="text-link">Exercise/Fitness supplies</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor} alt="Ecom"/></span><span
                            className="text-link">Jewellery</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor} alt="Ecom"/></span><span
                            className="text-link">Infant/Baby Products</span></a></li>
                      <li><a href="#"><span className="img-link"><img src={monitor} alt="Ecom"/></span><span
                            className="text-link">Restaurent</span></a></li>
                    </ul>
                    </div>
                </div>
                </div>
            ...
            <div className="header-nav d-inline-block">
              <nav className="nav-main-menu d-none d-xl-block">
                <ul className="main-menu">
                  <li> <a href="shop-grid.html">Fashion</a></li>
                  <li> <a href="shop-grid.html">Kid's Zone</a></li>
                  <li> <a href="shop-grid.html">Games</a></li>
                  <li> <a href="shop-grid.html">Electronics</a></li>
                  <li> <a href="shop-grid.html">Medicine & Fitness</a></li>
                  <li> <a href="shop-grid.html">Grocery</a></li>
                  <li> <a href="shop-grid.html">Food Court</a></li>
                  <li> <a href="shop-grid.html">Automotive & Agriculture</a></li>
  ...
  <div className="mobile-header-active mobile-header-wrapper-style perfect-scrollbar">
    <div className="mobile-header-wrapper-inner">
      <div className="mobile-header-content-area">
        <div className="mobile-logo"><a className="d-flex" href="index.html"><img alt="Ecom"
        ...
        <div className="perfect-scroll">
          ...
          <div className="mobile-account">
            <div className="mobile-header-top">
              <div className="user-account"><a href="page-account.html"><img src="assets/imgs/template/ava_1.png"
                    alt="Ecom"/></a>
          ...
          <div className="mobile-banner">
            <div className="bg-5 block-iphone"><span className="color-brand-3 font-sm-lh32">Starting from $899</span>
              ...
              <p className="font-base color-brand-3 mb-10">Special Sale</p><a className="btn btn-arrow"
                href="shop-grid.html">learn more</a>
            </div>
          </div>
          <div className="site-copyright color-gray-400 mt-30">Copyright 2022 &copy; Ecom - Marketplace
